package com.healthc.app.presentation.profile.adapter
...
import com.healthc.app.databinding.ItemProfileAllergyBinding
import com.healthc.domain.model.auth.Allergy

class ProfileAllergyAdapter(
    private val context: Context
) : ListAdapter<Allergy, ProfileAllergyAdapter.ProfileAllergyViewHolder>(AllergyDiffCallback){
